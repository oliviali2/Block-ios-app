...
extension UIColor {
    static let Green = UIColor(red:0.39, green:0.74, blue:0.36, alpha:1.0)
...
//        displayDetailsViewController(scannedCode: stringCodeValue)
        displayItemViewController(scannedCode: stringCodeValue)
...
//    }
    ...
    func displayItemViewController(scannedCode: String) {
        let itemViewController = ItemViewController()
        itemViewController.scannedCode = scannedCode
